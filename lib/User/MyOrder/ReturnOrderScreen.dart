  ...
  Future<void> _submit() async {
    if (!_canSubmit) {
      Fluttertoast.showToast(
        msg: 'Select at least one item and enter a return reason.',
      );
      return;
    }
    ...
    if (ok) {
      ...
      Fluttertoast.showToast(
        msg: 'Your return request has been submitted successfully.',
      );
    } else {
      Fluttertoast.showToast(
        msg: 'Could not submit return request. Please try again.',
      );
    }
  }
