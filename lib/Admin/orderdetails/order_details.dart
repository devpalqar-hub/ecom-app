...
import 'package:new_project/Admin/HomeScreen/Model/OrderModel.dart';
import 'package:new_project/Admin/HomeScreen/Service/DeliveryController.dart';
import 'package:new_project/utils.dart';
import 'package:new_project/Admin/TransferScreen/TransferScreen.dart';
...
Future<void> _makePhoneCall(String phone) async {
  ...
  if (await canLaunchUrl(uri)) {
    ...
    showAppNotification("Cannot open dialer", type: AppNotificationType.error);
  }
}
